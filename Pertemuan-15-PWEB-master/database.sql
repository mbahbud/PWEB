-- Pastikan Anda sudah membuat database di phpMyAdmin, misalnya: 'db_rpl_siswa'
-- Kemudian, jalankan query berikut di dalam database tersebut.
...
-- 3. Tabel opsional untuk kelas (jika dibutuhkan lebih lanjut)
/*
CREATE TABLE kelas (
    id_kelas INT PRIMARY KEY AUTO_INCREMENT,
    nama_kelas VARCHAR(10) NOT NULL UNIQUE
);
INSERT INTO kelas (nama_kelas) VALUES ('IX RPL');
*/